...
# 服务列表
declare -A SERVICES=(
  ["ExportLogs"]="plcruntime.PLCRuntimeService.ExportLogs"
  ["CreateProject"]="plcruntime.PLCRuntimeService.CreateProject" 
  ["ImportProgram"]="plcruntime.PLCRuntimeService.ImportProgram"
